...
/// </summary>
[Guid("7b148d3a-ba50-4f91-ae75-42d157e50877")]
internal sealed class TestParts :Instance<TestParts>{
    [Output(Guid = "6dc9ffe2-8986-48d3-ba62-70576b9b5ba6")]
    public readonly Slot<MeshGeometry> Result = new();

    [Output(Guid = "37e50eb4-23c6-4a65-a71a-f3f23e8800a4")]
    ...
    {
        var source = Geometree.GetValue(context);
    ...
    [Input(Guid = "d4d3fe09-0054-4708-92c8-87c84e34f61d")]
    public readonly InputSlot<MeshGeometry> Geometree = new();
}